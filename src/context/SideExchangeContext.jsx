...
const SideExchangeContext = createContext();

export const SideExchangeProvider = ({ children }) => {
...
export const useSideExchangeContext = () => {
  return useContext(SideExchangeContext);
};
